...
class MainMenuPresenter extends Presenter
{
    ...
    public function getMenuWithoutDropdownWrapper($item)
    {
        ...
        return '<li class="' . $this->getActiveState($item) . '"><a aria-current="page" href="' . $item->getUrl() . '" ' . $item->getAttributes() . '>' . $item->getIcon() . ' ' . $item->title . '</a></li>' . PHP_EOL;
    }    

    /**
     * {@inheritdoc }.
     */
    public function getActiveState($item, $state = 'current')
    {
