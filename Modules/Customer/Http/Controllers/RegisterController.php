    ...
    public function register(Request $request)
    {
        try {
            ...
            if (auth()->guard('customer')->check()) {
                return redirect()->route('fe.shoppingcart.myPurchase');
            }
            ...
            if ($customer) {
                ...
                if ($code) {
                    ...
                    if ($now > $expired_at) {
                        ...
                        return redirect()->route('fe.shoppingcart.myPurchase')->withSuccess(trans('customer::customers.messages.login_success'));
