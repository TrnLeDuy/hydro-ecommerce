...
$router->group(['prefix' => '/shoppingcart'], function (Router $router) {
    ...
    $router->get('/my-purchase', [
        'as' => 'fe.shoppingcart.myPurchase',
        'uses' => 'PublicController@myPurchase'
    ]);
    $router->get('/my-purchase/{order_id}/detail', [
        'as' => 'fe.shoppingcart.myPurchaseDetail',
        'uses' => 'PublicController@myPurchaseDetail',
    ]);
});
...
$router->get(trans('shoppingcart::shoppingcarts.router.order-detail') . '/{code}', [
    'as' => 'fe.shoppingcart.getOrderDetail',
    'uses' => 'PublicController@getOrderDetail'
]);
