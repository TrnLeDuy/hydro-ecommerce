        ...
        <div class="px-2 px-md-4">
            <div class="d-flex justify-content-between align-items-center pb-3 pb-md-4">
                <div class="d-flex flex-column">
                    <div class="fs-6 fs-md-5 mb-2">{{ __('setting.email-verify') }}</div>
                    <div class="fs-7 fs-md-6 fw-light pe-4">
                        {{ __('setting.email-description') }}
                    </div>
                </div>
                <a class="btn btn-secondary" style="min-width: 120px; color: #FFFFFF; cursor: default; pointer-events: none;">
                    {{ __('setting.verify-noti') }}
                </a>
            </div>
            ...
            <div class="d-flex justify-content-between align-items-center pb-3 pb-md-4">
                <div class="d-flex flex-column">
                    <div class="fs-6 fs-md-5 mb-2">{{ __('setting.logout-title1') }}</div>
                    <div class="fs-7 fs-md-6 fw-light pe-4">
                        {{ __('setting.logout-title2') }}
                    </div>
                </div>
                <a class="btn btn-primary " style="min-width: 120px" href="{{ route('fe.customer.customer.logout') }}">
                    {{ __('setting.logout-btn') }}
                </a>
            </div>
        </div>
    </div>
