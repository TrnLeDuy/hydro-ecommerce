...
<div class="profile py-4 py-md-5">
    <div class="px-3 px-md-4">
        <form class="form-profile row" method="post" action="{{ route('fe.customer.customer.account.updateProfile') }}" style="margin-bottom: 20px;">
            @csrf
            ...
            <div class="form-profile row">
                <div class="col-12 col-md-6">
                    <div class="form-item">
                        <label for="coutry" class="form-label">{{ __('profile.country') }}</label>
                ...
                <div class="col-12 col-md-6">
                    <div class="form-item">
                        <label for="address" class="form-label">{{ __('profile.address-label') }}</label>
                        <div class="input-group">
                            <input name="address" type="text" class="input secondary form-control" value="{{ $profile->address }}">
                            <div class="ms-2 end-icon-style">
                ...
                <div class="col-12 col-md-6">
                    <div class="form-item">
                        <label for="phone_number" class="form-label">{{ __('profile.phone-label') }}</label>
                        <div class="input-group">
                            {{-- <div class="text-nowrap">+84<span class="ms-2 me-2">|</span></div> --}}
                            <input name="phone_number" type="text" class="input form-control" value="{{ $profile->phone_number }}">
                            <div class="ms-2 end-icon-style">
                                <img width="18px" height="18px" src="{{ Theme::url('images/icons/edit.png') }}" alt="">
                            </div>
                        </div>
                ...
                <div class="col-12 col-md-6">
                    <div class="form-item">
                        ...
                        <input name="birthday" type="date" class="input secondary form-control" value="{{ $profile->birthday }}">
                        {{-- <div class="form-text">Error</div> --}}
                    </div>
                </div>
            </div>
