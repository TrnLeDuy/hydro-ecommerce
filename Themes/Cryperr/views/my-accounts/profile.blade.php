...
<div class="profile">
    <div class="px-3 px-md-4">
        ...
        <form class="form-profile row">
            ...
            <div class="col-12 col-md-6">
                <div class="form-item">
                    ...
                    <div class="input-group">
                        <input type="text" class="input secondary form-control disabled" value="{{$profile->address}}"
                            disabled>
                    </div>
                </div>
            </div>
            <div class="col-12 col-md-6">
                <div class="form-item">
                    <label for="phoneNumber" class="form-label">{{ __('profile.phone-label') }}</label>
                    <div class="input-group">
                        {{-- <div class="text-nowrap">+84<span class="ms-2 me-2">|</span></div> --}}
                        <input type="text" class="input form-control" value="{{$profile->phone_number}}"
                            disabled>
                    </div>
                </div>
            </div>
            <div class="col-12 col-md-6">
                <div class="form-item">
                    ...
                    <input type="date" class="input secondary form-control" value="{{$profile->birthday}}"
