    ...
    <div class="row clearfix">
      ...
      <div class="col-12 mb-3 form-group">
        ...
        <div class="input-group-password">
          <input type="password" class="form-control input" id="password" v-model="dataRequest.password" />
          <span class="togglePassword" ref="togglePassword"> </span>
          <div
      ...
      <div class="d-flex justify-content-between w-100">
        ...
        <a class="form-link" :href="linkForgot">{{ trans('auth.forgotpassword') }}</a>
      </div>
      <div class="action mt-3 d-flex justify-content-center">
        <button type="button" class="theme-btn btn-one" @click="submitLogin">
          {{ trans('auth.sign-in') }}
        </button>
      </div>
      <ModalVerifyLogin
