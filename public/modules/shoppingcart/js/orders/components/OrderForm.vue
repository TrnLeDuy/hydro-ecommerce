            ...
            <div class="box-body">
              ...
              <el-table :data="orderDetails" style="width: 100%">
                ...
                <el-table-column prop="price" label="Price" width="100">
                  <template slot-scope="scope">
                    {{ scope.row.price.toLocaleString('en-US', {minimumFractionDigits: 0, maximumFractionDigits: 2}) }}
                  </template>
                </el-table-column>
                ...
                <el-table-column prop="total" label="Total" width="100">
                  <template slot-scope="scope">
                    {{ scope.row.total.toLocaleString('en-US', {minimumFractionDigits: 0, maximumFractionDigits: 2}) }}
                  </template>
                </el-table-column>
              </el-table>
            ...
            <div class="box-body">
              <el-descriptions class="margin-top" title="Order Info" :column="1">
                <el-descriptions-item label="Total">{{
                  this.order.total.toLocaleString('en-US', {minimumFractionDigits: 0, maximumFractionDigits: 2})
                }}</el-descriptions-item>
                ...
                <el-descriptions-item label="Payment Method">
                  <el-select v-model="order.payment_method" placeholder="Select">
                    ...
                    <el-option key="4" label="PLC" :value="4">
                    </el-option>
                  </el-select>
                </el-descriptions-item>
