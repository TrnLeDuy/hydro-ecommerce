...
import ShoppingCartRoutes from "../../Modules/ShoppingCart/Assets/js/orders/OrderRoutes";
...
const router = new VueRouter({
  ...
  routes: [
    ...
    ...CrawHistoryRoutes, ...ProductRoutes, ...CategoryRoutes, ...ContactRoutes,
    ...
    ...PaymentmethodRoutes, ...ShoppingCartRoutes,
    ...AffiliateRoutes,
    ...TargetPriceRoutes,
    ...VolumnizerRoutes]
}),
